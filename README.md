...
|-----------|------|------------|
| T1528 | Steal Application Access Token | [OAuth consent high-risk permission](detections/credential-access/oauth-consent-high-risk-permission.md) |
...
| T1098 | Account Manipulation | [Cross-tenant access setting modified](detections/persistence/cross-tenant-access-setting-modified.md) |
...
**descambiado** — SOC Analyst specializing in Entra ID identity threat detection.
Coming from a deep offensive security background, now building the detections that catch the techniques I used to study.
